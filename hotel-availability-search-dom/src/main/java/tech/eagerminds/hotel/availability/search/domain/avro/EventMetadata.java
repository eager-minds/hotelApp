...
public class EventMetadata extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4049988115411970368L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EventMetadata\",\"namespace\":\"tech.eagerminds.hotel.availability.search.domain.avro\",\"fields\":[{\"name\":\"dateCreated\",\"type\":\"string\"},{\"name\":\"origin\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"traceId\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"user\",\"type\":[\"null\",\"string\"],\"default\":null}]}");
   ...
   */
  public EventMetadata(java.lang.CharSequence dateCreated, java.lang.CharSequence origin, java.lang.CharSequence traceId, java.lang.CharSequence user) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: dateCreated = (java.lang.CharSequence)value$; break;
   ...
   */
  public static tech.eagerminds.hotel.availability.search.domain.avro.EventMetadata.Builder newBuilder() {
    return new tech.eagerminds.hotel.availability.search.domain.avro.EventMetadata.Builder();
  }
   ...
   * @return A new EventMetadata RecordBuilder
   */
  public static tech.eagerminds.hotel.availability.search.domain.avro.EventMetadata.Builder newBuilder(tech.eagerminds.hotel.availability.search.domain.avro.EventMetadata.Builder other) {
    if (other == null) {
      return new tech.eagerminds.hotel.availability.search.domain.avro.EventMetadata.Builder();
    } else {
      return new tech.eagerminds.hotel.availability.search.domain.avro.EventMetadata.Builder(other);
    }
  }
   ...
   * @return A new EventMetadata RecordBuilder
   */
  public static tech.eagerminds.hotel.availability.search.domain.avro.EventMetadata.Builder newBuilder(tech.eagerminds.hotel.availability.search.domain.avro.EventMetadata other) {
    if (other == null) {
      return new tech.eagerminds.hotel.availability.search.domain.avro.EventMetadata.Builder();
    } else {
      return new tech.eagerminds.hotel.availability.search.domain.avro.EventMetadata.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EventMetadata>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(tech.eagerminds.hotel.availability.search.domain.avro.EventMetadata.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(tech.eagerminds.hotel.availability.search.domain.avro.EventMetadata other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.dateCreated)) {
        this.dateCreated = data().deepCopy(fields()[0].schema(), other.dateCreated);
    ...
    /**
      ...
      * @return This builder.
      */
    public tech.eagerminds.hotel.availability.search.domain.avro.EventMetadata.Builder setDateCreated(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public tech.eagerminds.hotel.availability.search.domain.avro.EventMetadata.Builder clearDateCreated() {
      dateCreated = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public tech.eagerminds.hotel.availability.search.domain.avro.EventMetadata.Builder setOrigin(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public tech.eagerminds.hotel.availability.search.domain.avro.EventMetadata.Builder clearOrigin() {
      origin = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public tech.eagerminds.hotel.availability.search.domain.avro.EventMetadata.Builder setTraceId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public tech.eagerminds.hotel.availability.search.domain.avro.EventMetadata.Builder clearTraceId() {
      traceId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public tech.eagerminds.hotel.availability.search.domain.avro.EventMetadata.Builder setUser(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public tech.eagerminds.hotel.availability.search.domain.avro.EventMetadata.Builder clearUser() {
      user = null;
    ...
    public EventMetadata build() {
      try {
        ...
        record.dateCreated = fieldSetFlags()[0] ? this.dateCreated : (java.lang.CharSequence) defaultValue(fields()[0]);
