...
public class MongoDbSteps extends CucumberSpringConfiguration {
  ...
  public void mongodbHasADocument(AvailabilitySearchEntity availabilitySearchEntity) {
    AvailabilitySearchEntity availabilitySearch = mongoOperations.save(availabilitySearchEntity);
    scenarioContext.setAvailabilitySearchEntity(availabilitySearch);
  }
}
