...
// This get will throw an exception if the service is not running
  ...
  public void request_body_is(AvailabilitySearchValueDto availabilitySearchValueDto) {
    scenarioContext.setSavedAvailabilitySearchValueDto(availabilitySearchValueDto);
    requestSpecification.body(availabilitySearchValueDto);
  }
