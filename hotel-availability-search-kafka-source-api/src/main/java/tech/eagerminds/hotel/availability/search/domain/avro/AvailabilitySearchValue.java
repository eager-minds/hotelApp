...
public class AvailabilitySearchValue extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static BinaryMessageDecoder<AvailabilitySearchValue> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<AvailabilitySearchValue>(MODEL$, SCHEMA$, resolver);
  }
   ...
   */
  public AvailabilitySearchValue(tech.eagerminds.hotel.availability.search.domain.avro.AvailabilitySearch entity, java.util.List<tech.eagerminds.core.kafka.domain.avro.EventMetadata> metadata) {
    this.entity = entity;
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvailabilitySearchValue>
    ...
    /**
      ...
      * @return This builder.
      */
    public tech.eagerminds.hotel.availability.search.domain.avro.AvailabilitySearchValue.Builder setMetadata(java.util.List<tech.eagerminds.core.kafka.domain.avro.EventMetadata> value) {
