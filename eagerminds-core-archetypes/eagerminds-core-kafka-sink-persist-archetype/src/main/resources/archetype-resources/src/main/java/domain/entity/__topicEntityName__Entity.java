...
public class ${topicEntityName}Entity {
  ...
  public ${topicEntityName}Entity() {
  }

  public ${topicEntityName}Entity(String id, String myString, Integer myInt,
