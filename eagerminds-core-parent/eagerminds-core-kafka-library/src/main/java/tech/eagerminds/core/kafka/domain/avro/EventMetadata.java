...
public class EventMetadata extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public EventMetadata(String dateCreated, String origin, String traceId, String user) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EventMetadata>
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setDateCreated(String value) {
    ...
    public EventMetadata build() {
      try {
        ...
        record.dateCreated = fieldSetFlags()[0] ? this.dateCreated : (String) defaultValue(fields()[0]);
        record.origin = fieldSetFlags()[1] ? this.origin : (String) defaultValue(fields()[1]);
        record.traceId = fieldSetFlags()[2] ? this.traceId : (String) defaultValue(fields()[2]);
