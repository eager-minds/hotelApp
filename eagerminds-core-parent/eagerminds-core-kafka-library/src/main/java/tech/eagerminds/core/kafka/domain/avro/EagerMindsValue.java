...
public class EagerMindsValue extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private java.util.List<EventMetadata> metadata;
   ...
   */
  public EagerMindsValue(String entity, java.util.List<EventMetadata> metadata) {
    this.entity = entity;
  ...
  public void put(int field$, Object value$) {
    ...
    case 1: metadata = (java.util.List<EventMetadata>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public java.util.List<EventMetadata> getMetadata() {
    return metadata;
  }
   ...
   * @param value the value to set.
   */
  public void setMetadata(java.util.List<EventMetadata> value) {
    this.metadata = value;
  }
   ...
   * @return A new EagerMindsValue RecordBuilder
   */
  public static Builder newBuilder(EagerMindsValue other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EagerMindsValue>
     ...
     * @param other The existing instance to copy.
     */
    private Builder(EagerMindsValue other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.entity)) {
        this.entity = data().deepCopy(fields()[0].schema(), other.entity);
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setEntity(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setMetadata(java.util.List<EventMetadata> value) {
    ...
    public EagerMindsValue build() {
      try {
        ...
        record.entity = fieldSetFlags()[0] ? this.entity : (String) defaultValue(fields()[0]);
        record.metadata = fieldSetFlags()[1] ? this.metadata : (java.util.List<EventMetadata>) defaultValue(fields()[1]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (this.metadata == null) {
      ...
      long actualSize0 = 0;
      for (EventMetadata e0: this.metadata) {
        actualSize0++;
        out.startItem();
        e0.customEncode(out);
      }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (in.readIndex() != 1) {
        ...
        java.util.List<EventMetadata> a0 = this.metadata;
        if (a0 == null) {
          a0 = new SpecificData.Array<EventMetadata>((int)size0, SCHEMA$.getField("metadata").schema().getTypes().get(1));
          this.metadata = a0;
        } else a0.clear();
        SpecificData.Array<EventMetadata> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<EventMetadata>)a0 : null);
        for ( ; 0 < size0; size0 = in.arrayNext()) {
          for ( ; size0 != 0; size0--) {
            EventMetadata e0 = (ga0 != null ? ga0.peek() : null);
            if (e0 == null) {
              e0 = new EventMetadata();
            }
            e0.customDecode(in);
            a0.add(e0);
          }
