...
import static tech.eagerminds.core.kafka.library.helper.MessageHelper.compareMessages;
  ...
  void produceMessageUsingBindingProducerName() {
    ...
    verify(genericConsumerMessageParser, timeout(1000))
        .getMessageWithHeader(
            argThat(receivedMessage -> compareMessages(publishEagerMindsMessage, receivedMessage)),
